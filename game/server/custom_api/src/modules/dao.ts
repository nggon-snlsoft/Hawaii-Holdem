...
dao.SELECT_SALES_USERS = function ( cb: any ) {

	let sql = 'SELECT * FROM sales_user';
	let args = null;
...
dao.SELECT_TICKETS = function ( cb: any ) {
...
dao.INSERT_SALES_USER = function ( data: any, cb: any ) {
	...
	let rolling_rakes = data.rolling_rakes;
	let rake_back = data.rake_back;
	let useTicket = data.useTicket;
	let updateDate = data.updateDate;
	let createDate = data.createDate;

	let sql = 'INSERT INTO sales_user (user_id, store_id, distributor_id, partner_id, year, month, day, timestamp, charge, point, transfer, wins, rakes, bettings, rollings, rolling_rakes, rake_back, useTicket, updateDate, createDate  ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)';
	let args = [user_id, store_id, distributor_id, partner_id, year, month, day, timestamp, charge, point, transfer, wins, rakes, bettings, rollings, rolling_rakes, rake_back, useTicket, updateDate, createDate ];
...
dao.TRUNCATE_SALES_USER = function ( cb: any ) {
	let sql = "TRUNCATE sales_user";
