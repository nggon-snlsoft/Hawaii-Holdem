...
exports.DealerCalculation = void 0;
const logger = require("../util/logger");
class DealerCalculation {
    constructor() {
        this.dealer = -1;
        this.sb = -1;
        this.bb = -1;
    ...
    FindSeatNoLastBlinder(entities) {
        if (this.dealer < 0) {
            return -1;
        }
        let seat = -1;
    ...
    FindEntityFromSeat(entities, seat) {
        let entity = null;
        entities.forEach(element => {
    ...
    CheckWaitOrSitOut(entity) {
        return (false === entity.wait) && (false === entity.isSitOut);
    }
    IsPlayableSeat(entities, seat) {
        let st = this.dealer;
        let ret = true;
...
exports.DealerCalculation = DealerCalculation;
