...
exports.default = arena_1.default({
    ...
    initializeGameServer: (gameServer) => {
        ...
        dao.init(sqlClient);
        gameServer.define("full", HoldemRoom_1.HoldemRoom, { dao: dao, ts: "full", clientLimit: 9 }).filterBy(["serial"]);
        gameServer.define("short", HoldemRoom_1.HoldemRoom, { dao: dao, ts: "short", clientLimit: 6 }).filterBy(["serial"]);
